...
from research.erc.plan import SUPPORTED, REJECTED, INCONCLUSIVE, NOT_EVALUATED

from Science import metrics as distance_module
...
class MeasurementRecord:
    ...
    def __init__(self, entry):
        ...
        # PASS / WARNING / HARDWARE_QC_FAIL, as Science/quality.py
...
class ExplorationAnalysis:
    ...
    def evaluate_predictions(self):
        ...
        from research.erc.sites import (
    ...
    def evaluate_hypothesis(self):
        ...
        from research.erc.sites import COMPARISON_TARGET, COMPARISON_CONTROL
