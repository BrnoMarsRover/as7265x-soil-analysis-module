"""
Scientific configuration for the Measurements layer.

Measurements understands. This file holds every number that represents a
...
Layer rule: Measurements may consume BD records and schema constants.
BD must never import Measurements.
"""
...
# ----------------------------------------------------------------------
# See Measurements/metrics/ and ARCHITECTURE.md. The short version:
#
...
# Historical names, kept so existing records and callers still resolve.
METRIC_WEIGHTS = FAMILY_WEIGHTS
METRIC_AGREEMENT_RANK_TOLERANCE = FAMILY_AGREEMENT_RANK_TOLERANCE
